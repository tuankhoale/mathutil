...
class MathUtilityTest {
    ...
    //VERIFY getFactorial() with n < 0, e.g n = 5 to throw Exception
    //Steps
    ...
    @Test
    public void testFactorialGivenWrongArgumentMinus5ThrowsExpection(){

        //ta phải đo xem ngoại lệ đã đến chưa
